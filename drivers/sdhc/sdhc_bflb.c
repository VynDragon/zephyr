 ...
 * They use SDH_STD_V3: frequency is controlled via GLB divider only,
 ...
 */
#define SDH_SRC_CLK_HZ		MHZ(96)
#define SDH_CLK_SEL		0U
#define SDH_GLB_DIV_INIT	8
#define SDH_GLB_DIV_MAX		8
...
static int sdhc_bflb_init(const struct device *dev)
{
	...
	sdhc_bflb_set_glb_clk_div(SDH_SRC_CLK_HZ);
	...
	/*  Enable status bits for polling (32-bit write) */
	sdhc_bflb_enable_status_bits(base);
